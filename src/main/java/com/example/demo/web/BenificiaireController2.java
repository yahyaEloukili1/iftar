...
//	}c
	...
	@GetMapping("/all2")
	public List<Benificiaire2> getAllBenificiaires(){
		return bennifBenificiaireRepository2.findAll();
	}
	
	
	@GetMapping("/doublons2")
	public List<Benificiaire2> getBenificiairesGroupedByCin() {
	    List<Benificiaire2> benificiaires = bennifBenificiaireRepository2.findAll();
	    Map<String, List<Benificiaire2>> groupedByCin = benificiaires.stream()
	        .collect(Collectors.groupingBy(Benificiaire2::getCin));
